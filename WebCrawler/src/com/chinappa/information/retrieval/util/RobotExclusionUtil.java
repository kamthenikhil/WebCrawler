...
public class RobotExclusionUtil {
	private static ConcurrentHashMap<String, ConcurrentHashMap<String, Boolean>> map = new ConcurrentHashMap<String, ConcurrentHashMap<String, Boolean>>();
	...
	public static boolean robotsShouldFollow(String url) {
		try {
			...
			if (!map.containsKey(site)) {
				String robotText = readRobotsFile(url("http://" + site
						+ "/robots.txt"));
				if (robotText != null) {
